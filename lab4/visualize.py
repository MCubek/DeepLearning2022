...
if __name__ == '__main__':
    ...
    models = {'SimpleMetricEmbedding Default': SimpleMetricEmbedding(1, emb_size).to(device),
              'SimpleMetricEmbedding Trained': torch.load('models/MNIST_model.pt'),
              'Identity Model': torch.load('models/MNIST_model_identity.pt'),
              'SimpleMetricEmbedding Trained Without Class': torch.load('models/MNIST_model_without_class.pt')}
